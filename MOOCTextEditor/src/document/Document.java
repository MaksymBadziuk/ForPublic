...
//    System.out.println("DEBUG ====> " + word + " -> " + numberOfSlogs);
    
	  return numberOfSlogs;
	}
	...
	public double getFleschScore()
	{
	  ...
	  double score = 206.835 - (1.015 * ((double)numWords / (double)numSentences )) - (84.6 * ((double)numSyllables / (double)numWords));
